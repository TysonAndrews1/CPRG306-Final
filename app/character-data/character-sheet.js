                ...
                <div className="flex flex-row items-stretch p-3 m-1 bg-slate-900 rounded">
                    ...
                    <div className="flex flex-col items-stretch">
                        ...
                        <div className="container">
                            <div className="centered-flex-row justify-evenly">
                                <div className="centered-flex-column">
                    ...
                    <div className="flex flex-col items-stretch">
                        <div className="container">
                            ...
                            <div className="centered-flex-row">
                                ...
                                <h2 className="label-styles">Acrobatics</h2>
                            </div>
                            <div className="centered-flex-row">
                                ...
                                <h2 className="label-styles">Animal Handling</h2>
                            </div>
                            <div className="centered-flex-row">
                                ...
                                <h2 className="label-styles">Arcana</h2>
                            </div>
                            <div className="centered-flex-row">
                                ...
                                <h2 className="label-styles">Athletics</h2>
                            </div>
                            <div className="centered-flex-row">
                                ...
                                <h2 className="label-styles">Deception</h2>
                            </div>
                            <div className="centered-flex-row">
                                ...
                                <h2 className="label-styles">History</h2>
                            </div>
                            <div className="centered-flex-row">
                                ...
                                <h2 className="label-styles">Insight</h2>
                            </div>
                            <div className="centered-flex-row">
                                ...
                                <h2 className="label-styles">Intimidation</h2>
                            </div>
                            <div className="centered-flex-row">
                                ...
                                <h2 className="label-styles">Investigation</h2>
                            </div>
                            <div className="centered-flex-row">
                                ...
                                <h2 className="label-styles">Medicine</h2>
                            </div>
                            <div className="centered-flex-row">
                                ...
                                <h2 className="label-styles">Nature</h2>
                            </div>
                            <div className="centered-flex-row">
                                ...
                                <h2 className="label-styles">Perception</h2>
                            </div>
                            <div className="centered-flex-row">
                                ...
                                <h2 className="label-styles">Performance</h2>
                            </div>
                            <div className="centered-flex-row">
                                ...
                                <h2 className="label-styles">Persuasion</h2>
                            </div>
                            <div className="centered-flex-row">
                                ...
                                <h2 className="label-styles">Religion</h2>
                            </div>
                            <div className="centered-flex-row">
                                ...
                                <h2 className="label-styles">Sleight of Hand</h2>
                            </div>
                            <div className="centered-flex-row">
                                ...
                                <h2 className="label-styles">Stealth</h2>
                            </div>
                            <div className="centered-flex-row">
                                ...
                                <h2 className="label-styles">Survival</h2>
                            </div>
                        </div>
                    </div>
                </div>
