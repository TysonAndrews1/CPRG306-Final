...
export default function CharacterAttributes({dndCharacterValues}) {
  ...
  //other
  const [charPassiveWisdom, setCharPassiveWisdom] = useState(0);
  ...
  return (
    <main className="flex flex-col items-center bg-slate-400 min-h-screen">
      ...
      <div className="flex flex-col items-center bg-slate-900 rounded p-3 m-1">
          ...
          <div className="flex flex-col items-stretch">
            ...
            <div className="flex flex-col items-stretch">
              <div className="flex flex-rol justify-between bg-slate-600 rounded p-3 m-1 items-center">
                <input className="text-black p-1 m-1 rounded text-end w-12 border-4 border-stone-400" type="number" value={charPassiveWisdom} onChange={(e) => setCharPassiveWisdom(e.target.value)} />
